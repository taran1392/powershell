...
$folder = "C:\test\2017-03-22\"  #New-Item -ItemType Directory C:\test\$(Get-Date -Format yyyy-MM-dd)

$passowrdFile="$folder\password.txt"
...
#create credentials object from password file

    $credInfo=Get-Content $passowrdFile
